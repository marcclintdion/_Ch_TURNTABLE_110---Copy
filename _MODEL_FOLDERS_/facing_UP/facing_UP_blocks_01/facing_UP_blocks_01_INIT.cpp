...
/*        #ifdef __APPLE__                                                                                                                          
        ...
        filePathName = [[NSBundle mainBundle] pathForResource:@"facing_UP_blocks_01_step" ofType:@"png"];                                                  
        image = imgLoadImage([filePathName cStringUsingEncoding:NSASCIIStringEncoding]);                                                   
        glGenTextures(1, &facing_UP_blocks_01_);                                                                                                     
   ...
   //------------------------------------------------------------------------------------------                                              
        #ifdef WIN32                                                                                                                            
        loadTexture("_MODEL_FOLDERS_/facing_UP/facing_UP_blocks_01/facing_UP_blocks_01_step.png",          facing_UP_blocks_01_NORMALMAP);          
        loadTexture("_MODEL_FOLDERS_/facing_UP/facing_UP_blocks_01/facing_UP_blocks_01_DOT3.bmp",          facing_UP_blocks_01_NORMALMAP);                                                     
        loadTexture("_MODEL_FOLDERS_/facing_UP/facing_UP_blocks_01/facing_UP_blocks_01.png",               facing_UP_blocks_01_TEXTUREMAP);                                                        
        #endif                                                                                                                                    
*/       //------------------------------------------------------------------------------------------------------------//___LOAD_VBO               
